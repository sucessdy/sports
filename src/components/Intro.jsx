...
export default function Intro() {
  ...
  return (
    <header className={`z-[999] relative `}>
      <motion.div
        className="flex fixed top-0 left-1/2 -translate-x-1/2 h-[4.5rem] w-full opacity-50 glassmorphism   bg-opacity-40 shadow-lg shadow-black/5 backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.5rem] sm:w-full sm:rounded-lg items-center  sm:justify-between"
      ...
      >
        ...
        <nav className="3/4 fixed flex top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0">
          <ul
        ...
        <DarkMode className=" flex justify-between absolute items-center gap-4 mx-4" />
          <motion.a
            href="./login"
